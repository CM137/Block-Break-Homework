...
//  Q.load(['blockbreak.png','blockbreak.json'], function() {
  Q.load(['blockbreak.png', 'block.mp3', 'paddle.mp3', 'wall.mp3'], function() {
	...
	Q.scene('title',function(stage) {
        ...
        var label1 = container.insert(new Q.UI.Text({x: -10, y: 230, color: "white",
                            label: " Controls", size: 32 }));
        var label2 = container.insert(new Q.UI.Text({x: -10, y: 265, color: "white",
                            label: "    Move Mouse", size: 18 }));
        var label3 = container.insert(new Q.UI.Text({x: -10, y: 185, color: "white",
